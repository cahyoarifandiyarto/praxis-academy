...
import 'dart:math';
import 'package:provider_state_management/weather_state.dart';
...
class _WeatherPageState extends State<WeatherPage> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text("Fake Weather App with Provider"),
        ),
        body: Container(
      ...
      child: Consumer<WeatherFake>(
        builder: (context, weatherFake, _) => TextField(
          ...
          onSubmitted: (newValue) {
            ...
            weatherFake.temperature = 20 + Random().nextInt(15) + Random().nextDouble();
          },
